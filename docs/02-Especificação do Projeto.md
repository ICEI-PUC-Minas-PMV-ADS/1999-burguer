...
| RF-033 | A aplicação mobile deverá possuir uma tela de cardápio, possibilitando a visualização dos produtos | ALTA |
...
| RF-036 | Na tela de carrinho, permitir a manutenção dos produtos escolhidos, o que inclui: exclusão do produto, aumentar quantidade do produto e diminuir quantidade do produto | ALTA |
...
| RF-039 | A aplicação mobile deverá possuir uma tela para manutenção do cadastro do usuário | MÉDIA |
