...
INSERT INTO teste.pedido (id, usuario_id, total, endereco, numero, bairro, cidade, cep, uf, status, data_finalizacao) VALUES (1, 3, 24.80, 'Rua nilza brito', '51', 'vitoria', 'belo horizonte', '31970755', 'MG',true, TO_TIMESTAMP(1633530000));
INSERT INTO teste.pedido (id, usuario_id, total, endereco, numero, bairro, cidade, cep, uf, status, data_finalizacao) VALUES (2, 3, 40.90, 'Rua nilza brito', '51', 'vitoria', 'belo horizonte', '31970755', 'MG',true, TO_TIMESTAMP(1633530000));
INSERT INTO teste.pedido (id, usuario_id, total, endereco, numero, bairro, cidade, cep, uf, status, data_finalizacao) VALUES (3, 2, 35.00, 'Rua nilza brito', '51', 'vitoria', 'belo horizonte', '31970755', 'MG', true, TO_TIMESTAMP(1633530000));
