...
//PedidosProdutos
router.get('/order-products/:order-id', authValidator, PedidosProdutoController.getOrderProductsDataValidation, PedidosProdutoController.getOrderProductsData)         //  A API deverá fornecer um endpoint GET para retornar produtos de um pedido
...
router.put('/user/:usuarioId', authValidator, UsuariosController.getUsuariosDataValidation, UsuariosController.updateUsuariosById)                         //  A API deverá fornecer um endpoint PUT para atualizar dados do usuário
